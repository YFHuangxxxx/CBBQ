...
if __name__ == '__main__':
    ...
    with open("C:\\data\\disease\\disambiguous.json", 'r', encoding='utf-8') as file:
        data = json.load(file)
    ...
    for i, dic in enumerate(data):
        ...
        final_df.to_csv("C:\\data\\disease\\gpt-3.5-result_disamb2.csv", mode='a', header=False)
        with open("C:\\data\\disease\\gpt-3.5-result_disamb2.csv", "a", encoding="utf-8") as f:
            f.write(ans + "\n")
