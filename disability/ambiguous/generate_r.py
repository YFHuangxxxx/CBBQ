...
# 读取csv文件
df = pd.read_csv('C:\\Users\\14190\\Desktop\\bias_data\\bias_data\\data\\disability\\templates_generate_nonneg.csv', encoding='utf-8-sig')  
...
for index, row in df.iterrows():
    ...
    for name1, name2 in itertools.product(ast.literal_eval(row['NAME1']), ast.literal_eval(row['NAME2'])):
        ...
        answer1 = row['ans0'].replace('{{NAME1}}', name1)
        answer2 = row['ans1'].replace('{{NAME2}}', name2)
...
# 写入新的csv文件
df_new.to_csv('C:\\Users\\14190\\Desktop\\bias_data\\bias_data\\data\\disability\\templates_generate_nonneg_output.csv', index=False)
