...
# 读取csv文件
df = pd.read_csv('C:\\Users\\14190\\Desktop\\bias_data\\bias_data\\data\\sexual_orientation\\templates_generate_nonneg.csv', encoding='utf-8-sig')  
...
# 写入新的csv文件
df_new.to_csv('C:\\Users\\14190\\Desktop\\bias_data\\bias_data\\data\\sexual_orientation\\templates_generate_nonneg_output.csv', index=False)
